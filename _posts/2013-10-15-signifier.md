...
ロック画面に表示されるバー
<img src="http://kwaka1208.net/wp-content/uploads/2013/10/iOS7-lock.png" alt="iOS7 Lock画面" width="300" height="533" class="alignnone size-full wp-image-526" />

<h2>気付きが減らされたロック画面のカメラボタン</h2>
...
iOS6のロック画面カメラボタン
<img src="http://kwaka1208.net/wp-content/uploads/2013/10/iOS6-camera.png" alt="iOS6 カメラボタン" width="300" height="90" class="alignnone size-full wp-image-522" />

iOS7のロック画面カメラボタン
<img src="http://kwaka1208.net/wp-content/uploads/2013/10/iOS7-camera.png" alt="iOS7 カメラボタン" width="300" height="96" class="alignnone size-full wp-image-525" />


<h2>気付きが弱くなった戻るボタン</h2>
...
iOS6の戻るボタン
<img src="http://kwaka1208.net/wp-content/uploads/2013/10/iOS6-back.png" alt="iOS6 戻るボタン" width="300" height="42" class="alignnone size-full wp-image-520" />

iOS7の戻るボタン
<img src="http://kwaka1208.net/wp-content/uploads/2013/10/iOS7-back.png" alt="iOS7 戻るボタン" width="300" height="42" class="alignnone size-full wp-image-523" />

<h2>気付きが与えられた通知バナー</h2>
...
iOS6の通知バナー
<img src="http://kwaka1208.net/wp-content/uploads/2013/10/iOS6-banner.png" alt="iOS6 通知バナー" width="300" height="38" class="alignnone size-full wp-image-527" />

iOS7の通知バナー
<img src="http://kwaka1208.net/wp-content/uploads/2013/10/iOS7-banner.png" alt="iOS7 通知バナー" width="300" height="60" class="alignnone size-full wp-image-524" />


このように、ユーザーインターフェースにおける「気付き」とは、ボタンに「戻る」と書いてあるから「これを押すと前の画面に戻れる」と理解することではありません。その形や前後の文脈から得られるものなのです。

<h2>Appleの新しいユーザーインターフェースに期待</h2>
